...
void lock(int thread){
    ...
    //Here is the critical fence, where on multicores, two threads could set their values to false
    //and run in the critical section, so we need to flush out the false value into RAM as soon as possible
